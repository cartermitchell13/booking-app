        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4 sm:py-6">
            ...
            <div className="hidden sm:flex items-center space-x-4">
              ...
              <button
                ...
                className="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 transition-all duration-200 min-h-[44px]"
              >
            ...
            <button
              ...
              className="sm:hidden p-2 rounded-lg text-gray-700 hover:bg-gray-100 transition-colors min-h-[44px] min-w-[44px]"
            >
          ...
          {showMobileMenu && (
            <div className="sm:hidden border-t border-gray-200 py-4">
              ...
              <button
                onClick={handleSignOut}
                className="w-full flex items-center px-4 py-3 text-sm font-medium rounded-lg text-gray-700 bg-gray-50 hover:bg-gray-100 transition-all duration-200 min-h-[44px]"
              >
                <LogOut className="h-4 w-4 mr-2" />
                Sign out
              </button>
